...
public class GDGameGameInputMappingFactory
{
    private static final GDGameGameInputMappingFactory SINGLETON = new GDGameGameInputMappingFactory();
    ...
    public GDGameGameInputMappingFactory()
    {   
