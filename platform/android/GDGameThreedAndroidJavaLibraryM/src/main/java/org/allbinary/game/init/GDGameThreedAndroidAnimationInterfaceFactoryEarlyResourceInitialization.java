...
public class GDGameThreedAndroidAnimationInterfaceFactoryEarlyResourceInitialization 
extends ResourceInitialization
{
    public GDGameThreedAndroidAnimationInterfaceFactoryEarlyResourceInitialization()
    {
    }
