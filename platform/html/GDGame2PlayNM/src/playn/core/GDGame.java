    ...
    implements PlayN2InputInterface
{
    ...
    public GDGame()
    {
        ...
        PlayN2InputConnector.getInstance().init(this);
    ...
    @Override
    public void onKeyDown(final Keyboard.KeyEvent event)
    {
        //logUtil.put(CommonLabels.getInstance().START_LABEL + event.key(), this, "onKeyDown");
    
        try {
            this.rawKeyEventHandler.fireEvent(event.key.ordinal(), this.DEVICE_ID, true);
        } catch(Exception e) {
            this.logUtil.put(CommonLabels.getInstance().START_LABEL + event.key.ordinal(), this, "onKeyDown", e);
        }
    ...
    @Override
    public void onKeyUp(final Keyboard.KeyEvent event)
    {
    ...
    public void onPointerStart(final Pointer.Event mouseEvent)
    {
        ...
        {
            this.logUtil.put(this.commonStrings.EXCEPTION, this, "onPointerStart", e);
        }
    }
    ...
    public void onPointerEnd(final Pointer.Event mouseEvent)
    {
        ...
        {
            this.logUtil.put(this.commonStrings.EXCEPTION, this, "onPointerEnd", e);
        }
    }
    ...
    public void onPointerDrag(final Pointer.Event mouseEvent)
    {
        ...
        {
            this.logUtil.put(this.commonStrings.EXCEPTION, this, "onPointerDrag", e);
        }
    }

    @Override
    public void onPointerCancel(playn.scene.Pointer.Event event) {
    ...
    public void onMouseDown(final Mouse.ButtonEvent mouseEvent)
    {
        try
        {
            //logUtil.putF(commonStrings.START, this, "onMouseDown");
            this.motionRecognizer.processStartMotionEvent((int) mouseEvent.x(), (int) mouseEvent.y(), this.DEVICE_ID, mouseEvent.button.ordinal());
        }
        catch (Exception e)
        {
    ...
    public void onMouseUp(final Mouse.ButtonEvent mouseEvent)
    {
        try
        {
            //logUtil.putF(commonStrings.START, this, "onMouseUp");
            this.motionRecognizer.processEndMotionEvent((int) mouseEvent.x(), (int) mouseEvent.y(), this.DEVICE_ID, mouseEvent.button.ordinal());
        }
        catch (Exception e)
        {
            this.logUtil.put(this.commonStrings.EXCEPTION, this, "onMouseUp", e);
        }
    }
    ...
    public void onMouseMove(final Mouse.MotionEvent mouseEvent)
    {
        ...
        {
            this.logUtil.put(this.commonStrings.EXCEPTION, this, "onMouseMove", e);
        }
    }
    ...
    public void onMouseWheelScroll(final Mouse.WheelEvent event)
    {
        try
        {
            //logUtil.putF(commonStrings.START, this, "onMouseWheelScroll");
            this.motionRecognizer.processScrolledMotionEvent((int) event.x(), (int) event.y(), this.DEVICE_ID, 0);
        }
        catch (Exception e)
        {
            this.logUtil.put(this.commonStrings.EXCEPTION, this, "onMouseWheelScroll", e);
        }
    }
