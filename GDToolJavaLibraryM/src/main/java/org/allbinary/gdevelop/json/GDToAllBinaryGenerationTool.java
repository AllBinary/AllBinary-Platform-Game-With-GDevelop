...
{   
    ...
    public void process() throws Exception {
        ...
        String xml = XML.toString(gdGameConfiguration);
        
        final AbFile abFile = new AbFile("G:\\mnt\\bc\\mydev\\GDGamesP\\platform\\android\\GDGameAndroidApplicationM\\src\\main\\res\\raw\\game.xml");
        if(abFile.exists()) {
            abFile.delete();
        }
