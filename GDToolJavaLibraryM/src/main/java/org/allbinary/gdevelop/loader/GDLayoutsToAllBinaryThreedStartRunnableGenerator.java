 ...
 * @author User
 */
public class GDLayoutsToAllBinaryThreedStartRunnableGenerator
{
    ...
    public GDLayoutsToAllBinaryThreedStartRunnableGenerator()
    {
    }
    ...
    public void process()
    {
        try
        {
            ...
            final InputStream inputStream = new FileInputStream(gdToolStrings.ROOT_PATH + "GDGameThreedBaseJavaLibraryM\\src\\main\\java\\org\\allbinary\\game\\GDLayoutStartRunnable.xsl");
