 ...
 * @author User
 */
public class GDSliderAnimationBehaviorFactory extends GDAnimationBehaviorBaseFactory {
    
    private static final GDSliderAnimationBehaviorFactory instance = new GDSliderAnimationBehaviorFactory();
