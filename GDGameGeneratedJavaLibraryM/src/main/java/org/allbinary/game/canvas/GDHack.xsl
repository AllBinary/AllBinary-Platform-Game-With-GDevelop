...
-->
    ...
    <xsl:template name="hackProcessing" >
        ...
        <xsl:if test="not(contains(disabled, 'true'))" >
            ...
            <xsl:variable name="alreadyUsedParentCondition" ><xsl:for-each select="../conditions" ><xsl:if test="type/value = 'SourisSurObjet' or type/value = 'IsCursorOnObject'" >found</xsl:if></xsl:for-each></xsl:variable>
...
-->
            ...
            <xsl:for-each select="conditions" >
                ...
                <xsl:if test="number($thisNodeIndex) != number(substring(generate-id(), 2) - 65536)" >
                <xsl:if test="not(type/value = 'DepartScene' or type/value = 'SceneJustBegins' or type/value = 'SoundPlaying') and (not(contains($caller, 'eventsCreateAssignGDObject') and type/value = 'NbObjet'))" >
                <xsl:variable name="parametersAsString0" ><xsl:for-each select="parameters" ><xsl:value-of select="text()" />,</xsl:for-each></xsl:variable>
                <xsl:variable name="parametersAsString" ><xsl:value-of select="translate(translate($parametersAsString0, '&#10;', ''), '\&#34;', '')" /></xsl:variable>
                //Condition nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> parameters=<xsl:value-of select="$parametersAsString" />
                ...
                <xsl:if test="type/value = 'CollisionNP' or type/value = 'Collision'" >
                    /* Collisions are handled by the Collision processor
                </xsl:if>
            </xsl:for-each>
            ...
            <xsl:if test="type/value = 'CreateByName' or type/value = 'ResizableCapability::ResizableBehavior::SetHeight' or type/value = 'JSONToVariableStructure2' or type/value = 'FileSystem.LoadStringFromFileSync' or type/value = 'ClearVariableChildren' or type/value = 'PushString' or type/value = 'SetX' or type/value = 'EcrireFichierTxt' or type/value = 'ReadStringFromStorage' or type/value = 'JSONToGlobalVariableStructure'" >
            //Was not called before h1
            </xsl:if>
            <xsl:if test="not(type/value = 'CreateByName' or type/value = 'ResizableCapability::ResizableBehavior::SetHeight' or type/value = 'JSONToVariableStructure2' or type/value = 'FileSystem.LoadStringFromFileSync' or type/value = 'ClearVariableChildren' or type/value = 'PushString' or type/value = 'SetX' or type/value = 'EcrireFichierTxt' or type/value = 'AddForceXY' or type/value = 'CameraX' or type/value = 'CameraY' or type/value = 'Cache' or type/value = 'Montre' or type/value = 'Show' or type/value = 'Hide' or type/value = 'SetGlobalVariableAsBoolean' or type/value = 'SetBooleanVariable' or type/value = 'PlaySoundCanal' or type/value = 'PlaySoundOnChannel' or type/value = 'TextContainerCapability::TextContainerBehavior::SetValue' or type/value = 'SetNumberVariable' or type/value = 'FileSystem::ReadDirectory' or type/value = 'BuiltinExternalLayouts::CreateObjectsFromExternalLayout')" >
            //Not currently calling, but could
            </xsl:if>
            <xsl:if test="type/value = 'CreateByName' or type/value = 'ResizableCapability::ResizableBehavior::SetHeight' or type/value = 'JSONToVariableStructure2' or type/value = 'FileSystem.LoadStringFromFileSync' or type/value = 'ClearVariableChildren' or type/value = 'PushString' or type/value = 'SetX' or type/value = 'EcrireFichierTxt' or type/value = 'ReadStringFromStorage' or type/value = 'JSONToGlobalVariableStructure' or type/value = 'AddForceXY' or type/value = 'CameraX' or type/value = 'CameraY' or type/value = 'Cache' or type/value = 'Montre' or type/value = 'Show' or type/value = 'Hide' or type/value = 'SetGlobalVariableAsBoolean' or type/value = 'SetBooleanVariable' or type/value = 'PlaySoundCanal' or type/value = 'PlaySoundOnChannel' or type/value = 'TextContainerCapability::TextContainerBehavior::SetValue' or type/value = 'SetNumberVariable' or type/value = 'FileSystem::ReadDirectory' or type/value = 'BuiltinExternalLayouts::CreateObjectsFromExternalLayout'" >
            gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(<xsl:value-of select="$index" />);
            </xsl:if>
            </xsl:if>
            ...
            <xsl:if test="not(contains($alreadyUsedCondition, 'found'))" >
                ...
                <xsl:if test="not((not(contains($processSubParentCondition, 'foundfound') and type/value = 'SetStringVariable')) or type/value = 'ModVarScene' or type/value = 'PlaySound' or type/value = 'Montre' or type/value = 'Delete' or ((type/value = 'MettreXY' or type/value = 'SetXY') and contains($isMultitouchSupported, 'found')))" >
            //Could I call this - //<xsl:value-of select="$processSubParentCondition" /> - //NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="type/value" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                ...
                <xsl:if test="(not(contains($processSubParentCondition, 'foundfound')) and type/value = 'SetStringVariable') or (type/value = 'ModVarScene' or type/value = 'PlaySound' or type/value = 'Montre' or ((type/value = 'MettreXY' or type/value = 'SetXY') and contains($isMultitouchSupported, 'found')))" >
            ...
            <xsl:if test="actions" >
                ...
                //Hackish - //<xsl:value-of select="$thisNodeArray" />
                        ...
                        <xsl:if test="not(contains(disabled, 'true'))" >
                        <xsl:call-template name="hackProcessingGDAction" >
                            ...
                            <xsl:with-param name="hadConditionOtherThanThis" >
                                <xsl:value-of select="$hadConditionOtherThanThis" />
                            </xsl:with-param>
                            <xsl:with-param name="hasCreate" >
                                <xsl:value-of select="$hasCreate" />
                            </xsl:with-param>
                            <xsl:with-param name="hasNoConditionsButDoesHaveUsedAction" >
                                <xsl:value-of select="$hasNoConditionsButDoesHaveUsedAction" />
                            </xsl:with-param>
                            <xsl:with-param name="hasCondition" >
                                <xsl:value-of select="$hasCondition" />
                            </xsl:with-param>
            ...
            <xsl:for-each select="actions" >
                ...
                <xsl:variable name="hasObjectGroup" >
                    ...
                    final int groupSize = <xsl:call-template name="globals" ><xsl:with-param name="name" ><xsl:value-of select="$gameLayerName" /></xsl:with-param></xsl:call-template>.<xsl:value-of select="$gameLayerName" />GDGameLayerListOfList.size();
                    for(int groupIndex = 0; groupIndex <xsl:text disable-output-escaping="yes" >&lt;</xsl:text> groupSize; groupIndex++) {
                        final BasicArrayList <xsl:value-of select="$gameLayerName" />GDGameLayerList = (BasicArrayList) <xsl:call-template name="globals" ><xsl:with-param name="name" ><xsl:value-of select="$gameLayerName" /></xsl:with-param></xsl:call-template>.<xsl:value-of select="$gameLayerName" />GDGameLayerListOfList.get(groupIndex);
                    </xsl:if>
...
<!--                //contains($caller, 'eventsCreateAssignGDObject') - START
                ...
                <xsl:if test="contains($hasExcludedEventBefore, 'found')" >
                    ...
                    <xsl:if test="contains($isInsideCondiion, 'found')" >
                        ...
                        <xsl:if test="contains($hasCondition, 'found')" >
                            ...
                            //Event nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> position=<xsl:value-of select="position()" /> type=<xsl:value-of select="type" /> <xsl:if test="object" > object=<xsl:value-of select="object" /></xsl:if> <xsl:if test="target" > target=<xsl:value-of select="target" /></xsl:if> disable=<xsl:value-of select="disabled" />
                            //Event - //BuiltinCommonInstructions::Repeat - call - //hack2
                            gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(<xsl:value-of select="$index" />);
                            </xsl:if>
                            <xsl:if test="type = 'BuiltinCommonInstructions::Link'" >
                            //Event nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> position=<xsl:value-of select="position()" /> type=<xsl:value-of select="type" /> <xsl:if test="object" > object=<xsl:value-of select="object" /></xsl:if> <xsl:if test="target" > target=<xsl:value-of select="target" /></xsl:if> disable=<xsl:value-of select="disabled" />
            ...
            //condition ending - //alreadyUsedCondition - not - END
                    ...
                    //1
                        logUtil.put(commonStrings.EXCEPTION_LABEL + "<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />", this, commonStrings.PROCESS, e);
                    }
...
//hackProcessing - END
     ...
     <xsl:template name="hackProcessingGDAction" >         
        <xsl:param name="caller" />
        <xsl:param name="layoutIndex" />
        <xsl:param name="parametersAsString" />
        <xsl:param name="createdObjectsAsString" />
        ...
        <xsl:param name="index" />
        <xsl:param name="repeat" />
        <xsl:param name="hadConditionOtherThanThis" />
        <xsl:param name="hasCreate" />
        <xsl:param name="hasNoConditionsButDoesHaveUsedAction" />
        ...
        <xsl:param name="eventTypeUp2Branches" />
            ...
            <xsl:variable name="usedActions" ><xsl:for-each select="actions" >
                <xsl:if test="type/value = 'Create'" >found</xsl:if><xsl:if test="type/value = 'RotateTowardPosition'" >found</xsl:if>
                <xsl:variable name="typeValue" select="type/value" />                
                <xsl:if test="$typeValue = 'ResetTimer'" >found</xsl:if><xsl:if test="$typeValue = 'PauseTimer'" >found</xsl:if>
                ...
                <xsl:if test="$typeValue = 'SetNumberObjectVariable'" >found</xsl:if>
            </xsl:for-each></xsl:variable>
                        
            <xsl:if test="contains($usedCondition, 'found') or contains($usedActions, 'found')" >
                        <xsl:variable name="total" ><xsl:value-of select="count(actions[type/value = 'MettreY' or type/value = 'SetY' or type/value = 'MettreXY' or type/value = 'SetXY' or type/value = 'MettreAutourPos' or type/value = 'PutAroundPosition'])" /></xsl:variable>
                        <xsl:variable name="listSize" ><xsl:for-each select="actions" ><xsl:if test="position() > 1" > + </xsl:if><xsl:if test="type/value = 'MettreY' or type/value = 'SetY' or type/value = 'MettreXY' or type/value = 'SetXY' or type/value = 'MettreAutourPos' or type/value = 'PutAroundPosition'" ><xsl:for-each select="parameters" ><xsl:if test="position() = 1" ><xsl:call-template name="globals" ><xsl:with-param name="name" ><xsl:value-of select="text()" /></xsl:with-param></xsl:call-template>.<xsl:value-of select="text()" />GDGameLayerList.size()</xsl:if></xsl:for-each></xsl:if><xsl:if test="not(type/value = 'MettreY' or type/value = 'SetY' or type/value = 'MettreXY' or type/value = 'SetXY' or type/value = 'MettreAutourPos' or type/value = 'PutAroundPosition')" >0</xsl:if></xsl:for-each></xsl:variable>
            ...
            //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Actions - //hadConditionOtherThanThis
            <xsl:for-each select="actions" >
                <xsl:if test="type/value = 'Create'" >
                    <xsl:for-each select="parameters" >
                        <xsl:if test="position() = 2" >
                            ...
                            //if(<xsl:call-template name="globals" ><xsl:with-param name="name" ><xsl:value-of select="text()" /></xsl:with-param></xsl:call-template>.<xsl:value-of select="text()" />GDGameLayerList.size() <xsl:text disable-output-escaping="yes" >&gt;=</xsl:text> size) {
                                ////logUtil.putF("A: Keep from creating again before last time: <xsl:value-of select="text()" />", this, commonStrings.PROCESS);
            ...
            <xsl:if test="not(contains($hasCreate, 'found'))" >
                       ...
                       <xsl:variable name="actionWithTextObjectString" >
                        ...
                        //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction
                        <xsl:for-each select="actions" >
                            <xsl:if test="type/value = 'Create'" >
                                <xsl:for-each select="parameters" >
                                    <xsl:if test="position() = 2" >

                        if(<xsl:call-template name="globals" ><xsl:with-param name="name" ><xsl:value-of select="text()" /></xsl:with-param></xsl:call-template>.<xsl:value-of select="text()" />GDGameLayerList.objectArray == nullUtil.NULL_OBJECT_ARRAY) {
                            logUtil.putF("<xsl:value-of select="$nodeIdAsString" /><xsl:value-of select="text()" />GDGameLayerList = new BasicArrayList(size);", this, commonStrings.PROCESS);
                        ...
                        //logUtil.put(stringBuilder.append("<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />").append(" Timer - size <xsl:value-of select="$text" />List startIndex: ").append(startIndex).append(" endIndex: ").append(endIndex).toString(), this, commonStrings.PROCESS, new Exception());
...
<!--            <xsl:if test="contains($hasCreate, 'found')" >
            ...
            <!--  -->
            //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Actions - 1
            <xsl:for-each select="actions" >
                <xsl:variable name="typeValue" select="type/value" />
                <xsl:text>&#10;</xsl:text>
                <xsl:variable name="parametersAsString0" ><xsl:for-each select="parameters" ><xsl:value-of select="text()" />,</xsl:for-each></xsl:variable>
            ...
            <xsl:if test="contains($hasNoConditionsButDoesHaveUsedAction, 'found')" >
                ...
                <xsl:if test="$typeValue = 'ModVarScene'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //ModVarScene - call - 1
                    gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(<xsl:value-of select="$index" />);
                </xsl:if>
                </xsl:if>
                ...
                <xsl:if test="$typeValue = 'Create'" >
                    ...
                    //hackProcessing - //hackProcessingGDAction - //createGDObject - START
                    ...
                    //hackProcessing - //hackProcessingGDAction - //createGDObject - END
                    
                    <xsl:variable name="name" ><xsl:for-each select="parameters" ><xsl:if test="position() = 2" ><xsl:value-of select="text()" /></xsl:if></xsl:for-each></xsl:variable>
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //Create - call
                ...
                <xsl:if test="$typeValue = 'MettreX' or $typeValue = 'SetX'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //MettreX - call
                    <xsl:for-each select="parameters" >
                        <xsl:if test="position() = 1" >
                ...
                <xsl:if test="$typeValue = 'MettreY' or $typeValue = 'SetY'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //MettreY - call
                ...
                <xsl:if test="$typeValue = 'MettreXY' or $typeValue = 'SetXY'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //MettreXY - call
                    gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].processGD(((GDGameLayer) globals.<xsl:for-each select="parameters" ><xsl:if test="position() = 1" ><xsl:value-of select="text()" />GDGameLayerList.get(index))</xsl:if></xsl:for-each>, null, globals.graphics);
                    <xsl:text>&#10;</xsl:text>
                    <xsl:for-each select="parameters" >
                        <xsl:if test="position() = 1" >
                ...
                <xsl:if test="$typeValue = 'MettreAutourPos' or $typeValue = 'PutAroundPosition'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //MettreXY - call
                    gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].processGD(((GDGameLayer) globals.<xsl:for-each select="parameters" ><xsl:if test="position() = 1" ><xsl:value-of select="text()" />GDGameLayerList.get(index))</xsl:if></xsl:for-each>, null, globals.graphics);
                    <xsl:text>&#10;</xsl:text>
                ...
                <xsl:if test="$typeValue = 'SetAngle'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //SetAngle - call
                    //index=<xsl:value-of select="$index" />
                ...
                <xsl:if test="$typeValue = 'SetZOrder' or $typeValue = 'ChangePlan'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //ChangePlan - call
                    //index=<xsl:value-of select="$index" />
                    if(gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(index)) {
                        <xsl:if test="contains($hasNoConditionsButDoesHaveUsedAction, 'found')" >
                        <xsl:if test="not(contains($hasCreate, 'found'))" >
                ...
                <xsl:if test="$typeValue = 'ChangeColor'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //ChangeColor - call
                    //index=<xsl:value-of select="$index" />
                    if(gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(index)) {
                        <xsl:if test="contains($hasNoConditionsButDoesHaveUsedAction, 'found')" >
                        <xsl:if test="not(contains($hasCreate, 'found'))" >
                ...
                <xsl:if test="$typeValue = 'AddForceAL'" >
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //AddForceAL - call
                    //index=<xsl:value-of select="$index" />
                    if(gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(index)) {
                        <xsl:if test="contains($hasNoConditionsButDoesHaveUsedAction, 'found')" >
                        <xsl:if test="not(contains($hasCreate, 'found'))" >
                ...
                <xsl:if test="$typeValue = 'ChangeAnimation'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //ChangeAnimation - call
                    //index=<xsl:value-of select="$index" />
                    if(gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(index)) {
                        <xsl:if test="contains($hasNoConditionsButDoesHaveUsedAction, 'found')" >
                        <xsl:if test="not(contains($hasCreate, 'found'))" >
                ...
                <xsl:if test="$typeValue = 'SetNumberObjectVariable'" >
                    //Action nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> type=<xsl:value-of select="$typeValue" /> inverted=<xsl:value-of select="type/inverted" /> parameters=<xsl:value-of select="$parametersAsString" />
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //SetNumberObjectVariable - call
                    //index=<xsl:value-of select="$index" />
                    if(gameGlobals.nodeArray[gameGlobals.NODE_<xsl:value-of select="number(substring(generate-id(), 2) - 65536)" />].process(index)) {
                        <xsl:if test="contains($hasNoConditionsButDoesHaveUsedAction, 'found')" >
                        <xsl:if test="not(contains($hasCreate, 'found'))" >
            ...
            //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - 2
            <xsl:for-each select="actions" >
<!--                <xsl:variable name="nodeIdAsString" >nodeId=<xsl:value-of select="generate-id()" /> - <xsl:value-of select="number(substring(generate-id(), 2) - 65536)" /> </xsl:variable>-->
                <xsl:variable name="typeValue" select="type/value" />
                <xsl:if test="$typeValue = 'Create'" >
                    //caller=<xsl:value-of select="$caller" /> - //hackProcessing - //hackProcessingGDAction - //Action - //Create - call - end
    ...
    <xsl:template name="addGameLayerToList" >
                    ...
                    <xsl:for-each select="parameters" >
                        ...
                        <xsl:variable name="gameLayerName" select="text()" />
                        <xsl:variable name="hasObjectGroup" >
                            <xsl:for-each select="//objectsGroups" >
                                <xsl:if test="name = $gameLayerName" >found</xsl:if>
                            </xsl:for-each>
                    ...
                    if(true) {
                        ...
                        if(<xsl:value-of select="$gameLayerName" />GDGameLayerList.size() <xsl:text disable-output-escaping="yes" >&gt;</xsl:text> index) {
                            final GDGameLayer gameLayer = (GDGameLayer) <xsl:value-of select="$gameLayerName" />GDGameLayerList.get(index);
