...
<xsl:text>                        </xsl:text>final int oldSize = <xsl:value-of select="$firstParam" />.<xsl:value-of select="$secondParam" />.length;
<xsl:text>                        </xsl:text><xsl:value-of select="$firstParam" />.<xsl:value-of select="$secondParam" /> = 
                                      arrayUtil.copyOfint(<xsl:value-of select="$firstParam" />.<xsl:value-of select="$secondParam" />, 
                                      <xsl:value-of select="$firstParam" />.<xsl:value-of select="$secondParam" />.length + 1);
