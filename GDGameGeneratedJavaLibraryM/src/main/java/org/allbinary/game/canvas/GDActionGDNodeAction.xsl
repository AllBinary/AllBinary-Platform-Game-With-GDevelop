...
<xsl:stylesheet version="1.0"
    ...
    <xsl:import href="./action/GDModVarGlobalTxtActionProcess.xsl" />
...
-->
            ...
            <xsl:if test="contains($selectedNodeIds, $selectedNodeIdWithSep) or string-length($selectedNodeIds) = 0" >
                ...
                <xsl:when test="$typeValue = 'ModVarGlobalTxt'" >
                    ...
                    <xsl:call-template name="modVarGlobalTxtActionProcess" >
                        <xsl:with-param name="forExtension" >
                            <xsl:value-of select="$forExtension" />
                        </xsl:with-param>
                        <xsl:with-param name="layoutIndex" >
                ...
                <xsl:when test="$typeValue = 'FileSystem.LoadStringFromFileSync'" >
                    <xsl:call-template name="fileSystemLoadStringFromFileSyncActionProcess" >
                        <xsl:with-param name="forExtension" >
                            <xsl:value-of select="$forExtension" />
                        </xsl:with-param>
                        <xsl:with-param name="layoutIndex" >
