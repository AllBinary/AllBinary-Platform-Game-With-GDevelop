...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="scalableBehaviorSetValueActionProcess" >
        ...
        <xsl:param name="createdObjectsAsString" />
                        ...
                        //ScalableCapability::ScalableBehavior::SetValue - action - //forExtension=<xsl:value-of select="$forExtension" />
                        ...
                        public boolean process() throws Exception {
                            ...
                            try {
                                ...
                                for(int index = 0; index <xsl:text disable-output-escaping="yes" >&lt;</xsl:text> size; index++) {
                                    ...
                                    <xsl:value-of select="$paramOne" />.scaleX = <xsl:value-of select="$paramOne" />.scaleY = <xsl:value-of select="$paramFour" />;
