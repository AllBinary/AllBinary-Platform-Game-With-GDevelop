...
//                .SetExtensionHelpPath("/objects/base_object/events");
        ...
        this.behaviorMetadata.addCondition("PosX",
                "X position",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .useStandardRelationalOperatorParameters(this.parameterFactory.NUMBER)
                .markAsSimple();

        this.behaviorMetadata.addAction("MettreX",
                "X position",
        ...
        this.behaviorMetadata.addCondition("PosY",
                "Y position",
        ...
        this.behaviorMetadata.addAction("MettreY",
                "Y position",
        ...
        this.behaviorMetadata.addAction("MettreXY",
                "Position",
                ...
                "res/actions/position.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OPERATOR, "Modification's sign", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "X position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OPERATOR, "Modification's sign", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Y position", this.stringUtil.EMPTY_STRING, false)
                .markAsSimple();

        this.behaviorMetadata.addAction("SetCenter",
                "Center position",
        ...
        this.behaviorMetadata.addExpressionAndConditionAndAction(this.parameterFactory.NUMBER, "CenterX",
                "Center X position",
        ...
        this.behaviorMetadata.addExpressionAndConditionAndAction(this.parameterFactory.NUMBER, "CenterY",
                "Center Y position",
        ...
        this.behaviorMetadata.addAction("MettreAutourPos",
                ...
                .addParameter(this.parameterFactory.EXPRESSION, "X position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Y position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Distance", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Angle, in degrees", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();

        this.behaviorMetadata.addAction("SetAngle",
                "Angle",
        ...
        this.behaviorMetadata.addAction("Rotate",
                "Rotate",
                ...
                "res/actions/direction.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Angular speed (in degrees per second)", this.stringUtil.EMPTY_STRING, false)
                .addCodeOnlyParameter("currentScene", this.stringUtil.EMPTY_STRING)
                .markAsSimple();

        this.behaviorMetadata.addAction(
                "RotateTowardAngle",
                "Rotate toward angle",
                ...
                "res/actions/direction.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Angle to rotate towards (in degrees)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Angular speed (in degrees per second)", this.stringUtil.EMPTY_STRING, false)
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Speed on X axis (in pixels per second)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Speed on Y axis (in pixels per second)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.FORCE_MULTIPLIER, "Force multiplier", this.stringUtil.EMPTY_STRING, false);

        this.behaviorMetadata.addAction("AddForceAL",
                "Add a force (angle)",
                ...
                "res/actions/force.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Angle", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Speed (in pixels per second)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.FORCE_MULTIPLIER, "Force multiplier", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "X position of the center", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Y position of the center", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Speed (in Degrees per seconds)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Distance (in pixels)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.FORCE_MULTIPLIER, "Force multiplier", this.stringUtil.EMPTY_STRING, false)
                .setHidden();

        this.behaviorMetadata.addAction("Arreter",
                "Stop the object",
        ...
        this.behaviorMetadata.addAction("Delete",
                "Delete the object",
        ...
        this.behaviorMetadata.addAction("ChangePlan",
                "Z order",
        ...
        this.behaviorMetadata.addAction("ChangeLayer",
                "Layer",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.LAYER, "Move it to this layer (base layer if empty)", this.stringUtil.EMPTY_STRING, false)
                .setDefaultValue("\"\"")
                .markAsAdvanced();

        this.behaviorMetadata.addAction("ModVarObjet",
                ...
                "res/actions/var.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Variable", this.stringUtil.EMPTY_STRING, false)
                .useStandardOperatorParameters(this.parameterFactory.NUMBER);
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.TRUE_OR_FALSE, "New Value:", this.stringUtil.EMPTY_STRING, false);
        ...
        this.behaviorMetadata.addCondition("ObjectVariableChildExists",
                "Child existence",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.STRING, "Name of the child", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();

        this.behaviorMetadata.addAction("ObjectVariableRemoveChild",
                "Remove a child",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.STRING, "Child's name", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();

        this.behaviorMetadata.addAction("ObjectVariableClearChildren",
                "Clear variable",
        ...
        this.behaviorMetadata.addAction("Cache",
                "Hide",
        ...
        this.behaviorMetadata.addAction("Montre",
                "Show",
        ...
        this.behaviorMetadata.addCondition("Angle",
                "Angle",
        ...
        this.behaviorMetadata.addCondition("Plan",
                "Z-order",
        ...
        this.behaviorMetadata.addCondition("Layer",
                "Current layer",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.LAYER, "Layer", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();

        this.behaviorMetadata.addCondition("Visible",
                "Visibility",
        ...
        this.behaviorMetadata.addCondition("Invisible",
        ...
        this.behaviorMetadata.addCondition("Arret",
        ...
        this.behaviorMetadata.addCondition("Vitesse",
                "Speed (from forces)",
        ...
        this.behaviorMetadata.addCondition("AngleOfDisplacement",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Angle, in degrees", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Tolerance, in degrees", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();

        this.behaviorMetadata.addCondition("VarObjet",
                "Value of an object variable",
        ...
        this.behaviorMetadata.addCondition("VarObjetTxt",
                "Text of an object variable",
        ...
        this.behaviorMetadata.addCondition("ObjectVariableAsBoolean",
                "Boolean value of an object variable",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.TRUE_OR_FALSE, "Check if the value is", this.stringUtil.EMPTY_STRING, false)
                .setDefaultValue("true");

        this.behaviorMetadata.addCondition("VarObjetDef",
                "Variable defined",
                ...
                "res/conditions/var.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.STRING, "Variable", this.stringUtil.EMPTY_STRING, false)
                .setHidden();
        ...
        this.behaviorMetadata.addAction(
                ...
                "res/actions/var.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Array variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.SCENE_VAR, "Scene variable with the content to append", this.stringUtil.EMPTY_STRING, false)
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Array variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.STRING, "String to append", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Array variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Number to append", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Array variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.TRUE_OR_FALSE, "Boolean to append", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_VAR, "Variable", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Index to remove", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();

        this.behaviorMetadata.addCondition("BehaviorActivated",
                "Behavior activated",
                ...
                "res/behavior16.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.BEHAVIOR, "Behavior", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();

        this.behaviorMetadata.addAction("ActivateBehavior",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.BEHAVIOR, "Behavior", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.YES_OR_NO, "Activate?", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_PTR, "Target Object", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Speed (in pixels per second)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.FORCE_MULTIPLIER, "Force multiplier", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                "res/actions/forceTourne.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_PTR, "Rotate around this object", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Speed (in degrees per second)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Distance (in pixels)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.FORCE_MULTIPLIER, "Force multiplier", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                "res/actions/positionAutour.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_PTR, "\"Center\" Object", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Distance", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Angle, in degrees", this.stringUtil.EMPTY_STRING, false)
                .markAsAdvanced();
        ...
        this.behaviorMetadata.addAction(
                ...
                .setHidden()
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_LIST, "Object 2 (won't move)", this.stringUtil.EMPTY_STRING, false);
        ...
        this.behaviorMetadata.addAction(
                ...
                "res/actions/ecarter.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_LIST, "Objects (won't move)", this.stringUtil.EMPTY_STRING, false)
        ...
        this.behaviorMetadata.addCondition(
                "CollisionPoint",
                "Point inside object",
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "X position of the point", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Y position of the point", this.stringUtil.EMPTY_STRING, false)
                .markAsSimple();
        ...
        this.platformExtension.addCondition(
                ...
                .addParameter(this.parameterFactory.OBJECT_LIST, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addCodeOnlyParameter("currentScene", this.stringUtil.EMPTY_STRING)
        ...
        this.behaviorMetadata.addCondition(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.STRING, "Timer's name", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Time in seconds", this.stringUtil.EMPTY_STRING, false);
        ...
        this.behaviorMetadata.addExpression(
                "X",
                "X position",
        ...
        this.behaviorMetadata.addExpression(
                ...
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_PTR, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false);
        ...
        this.behaviorMetadata.addExpression(
                ...
                "res/conditions/distance.png")
                .addParameter(this.parameterFactory.OBJECT, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Target X position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Target Y position", this.stringUtil.EMPTY_STRING, false);
        ...
        this.behaviorMetadata.addStrExpression(
                "VariableString",
                "Object variable",
                "Text of an object variable",
                "Variables",
        ...
        this.platformExtension
                ...
                .addParameter(this.parameterFactory.OBJECT_LIST_WITHOUT_PICKING, "Object to create", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "X position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Y position", this.stringUtil.EMPTY_STRING, false)
        ...
        this.platformExtension
                .addAction("CreateByName",
                        ...
                        "res/actions/create.png")
                .addCodeOnlyParameter("objectsContext", this.stringUtil.EMPTY_STRING)
                .addParameter(this.parameterFactory.OBJECT_LIST_WITHOUT_PICKING, "Group of potential objects", this.stringUtil.EMPTY_STRING, false)
                .setParameterLongDescription("Group containing objects that can be created by the action.")
                .addParameter(this.parameterFactory.STRING, "Name of the object to create", this.stringUtil.EMPTY_STRING, false)
        ...
        this.platformExtension.addCondition(
                ...
                .addParameter(this.parameterFactory.OBJECT_LIST, GDIdeBaseObjectExtension.OBJECT, this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_LIST, "Object 2", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Tolerance, in degrees", this.stringUtil.EMPTY_STRING, false)
                .addCodeOnlyParameter("conditionInverted", this.stringUtil.EMPTY_STRING)
                .markAsAdvanced();
        ...
        this.platformExtension.addCondition(
                ...
                .addParameter(this.parameterFactory.OBJECT_LIST, "Name of the object", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.OBJECT_LIST, "Name of the second object", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION,
                        "Angle of tolerance, in degrees (0: minimum tolerance)", this.stringUtil.EMPTY_STRING, false)
                .addCodeOnlyParameter("conditionInverted", this.stringUtil.EMPTY_STRING)
                .markAsAdvanced();
        ...
        this.platformExtension.addCondition(
                ...
                .addParameter(this.parameterFactory.OBJECT_LIST, "Objects to test against the ray", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Ray source X position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Ray source Y position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Ray angle (in degrees)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Ray maximum distance (in pixels)", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.SCENE_VAR, "Result X position scene variable", this.stringUtil.EMPTY_STRING, false)
                ...
                .addParameter(this.parameterFactory.SCENE_VAR, "Result Y position scene variable", this.stringUtil.EMPTY_STRING, false)
                .setParameterLongDescription(
        ...
        this.platformExtension.addCondition(
                ...
                .addParameter(this.parameterFactory.EXPRESSION, "Ray source X position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Ray source Y position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Ray target X position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.EXPRESSION, "Ray target Y position", this.stringUtil.EMPTY_STRING, false)
                .addParameter(this.parameterFactory.SCENE_VAR, "Result X position scene variable", this.stringUtil.EMPTY_STRING, false)
                .setParameterLongDescription(
                        "Scene variable where to store the X position of the intersection. If no intersection is found, the variable won't be changed.")
                .addParameter(this.parameterFactory.SCENE_VAR, "Result Y position scene variable", this.stringUtil.EMPTY_STRING, false)
        ...
        this.behaviorMetadata.addStrExpression("ObjectName",
                "Object name",
        ...
        this.behaviorMetadata.addStrExpression("Layer",
                "Object layer",
